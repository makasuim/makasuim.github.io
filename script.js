document.addEventListener('DOMContentLoaded', () => {
    ...
    const todosLosProductos = {
        juguetes: [
            ...
            { id: 2, nombre: 'Ratón de juguete para gato', precio: 3000, stock: 8, imagen: 'img/raton.jpeg', descripcion: 'Juguete suave con catnip para estimular el instinto de caza de tu gato.', imagenesAdicionales: ['img/ratomcitos.webp', 'img/raton.jpeg'] }, // Ajustado 'ratomcito.jpg' a 'ratomcitos.webp'
            { id: 3, nombre: 'Cuerda para morder', precio: 7000, stock: 5, imagen: 'img/morder.jpg', descripcion: 'Cuerda de algodón duradera para perros, ayuda a limpiar los dientes.', imagenesAdicionales: ['img/cuerda2.avif', 'img/cuerda3.webp'] }, // Ajustado 'cuerda2.jpg' a 'cuerda2.avif' y 'cuerda3.jpg' a 'cuerda3.webp'
            { id: 4, nombre: 'Juguete interactivo', precio: 12000, stock: 26, imagen: 'img/juguetepuzzleparaperros.webp', descripcion: 'Juguete dispensador de premios que desafía la mente de tu mascota.', imagenesAdicionales: ['img/interactivo.jpg', 'img/interactivo2.webp'] }, // Ajustado 'interactivo.webp' a 'interactivo.jpg' y 'interactivo2.jpg' a 'interactivo2.webp'
            { id: 5, nombre: 'Pelota con sonido', precio: 8000, stock: 17, imagen: 'img/pelota.jpg', descripcion: 'Pelota que emite sonidos divertidos al ser mordida, ideal para mantener a tu perro entretenido.', imagenesAdicionales: ['img/sonido.webp', 'img/sonido2.webp'] } // Ajustado 'sound.webp' a 'sonido.webp' y 'sound2.webp' a 'sonido2.webp'
        ],
        accesorios: [
            ...
            { id: 7, nombre: 'Correa ajustable', precio: 12000, stock: 8, imagen: 'img/accesorio.jpg', descripcion: 'Correa de nylon con longitud ajustable, ideal para paseos diarios.', imagenesAdicionales: ['img/correa1.avif', 'img/correa2.webp'] }, // Ajustado a imágenes de correa disponibles
            { id: 8, nombre: 'Arnés para perro', precio: 15000, stock: 5, imagen: 'img/arnes1.webp', descripcion: 'Arnés cómodo y seguro que distribuye la presión uniformemente.', imagenesAdicionales: ['img/arnes2.jpg', 'img/collarcorrea.jpg'] }, // Ajustado a imágenes de arnés disponibles
            { id: 9, nombre: 'Cama para gato', precio: 20000, stock: 6, imagen: 'img/cama.webp', descripcion: 'Cama suave y acogedora para gatos, con bordes elevados para mayor confort.', imagenesAdicionales: ['img/camagato2.jpg', 'img/camagato3.webp'] } // Ajustado a imágenes de cama de gato disponibles
        ],
        alimentos: [
            { id: 10, nombre: 'Comida seca para perros', precio: 25000, stock: 10, imagen: 'img/master.jpeg', descripcion: 'Alimento completo y balanceado para perros adultos, con proteínas de alta calidad.', imagenesAdicionales: ['img/comidaperro2.png', 'img/comidaperro3.png'] }, // Ajustado a imágenes de comida de perro disponibles
            { id: 11, nombre: 'Comida húmeda para gatos', precio: 15000, stock: 18, imagen: 'img/lata.jpg', descripcion: 'Paté delicioso y nutritivo para gatos, ideal para complementar su dieta.', imagenesAdicionales: ['img/comidahumeda1.avif', 'img/comidahumeda2.jpg'] }, // Ajustado a imágenes de comida húmeda disponibles
            { id: 12, nombre: 'Snacks para perros', precio: 8000, stock: 15, imagen: 'img/snackperro.png', descripcion: 'Premios masticables para perros, ayudan a la higiene dental.', imagenesAdicionales: ['img/snackperro2.jpg', 'img/snackperro3.jpg'] }, // Ajustado a imágenes de snacks de perro disponibles
            { id: 13, nombre: 'Snacks para gatos', precio: 7000, stock: 16, imagen: 'img/sanac.jpg', descripcion: 'Bocadillos crujientes para gatos, con vitaminas y minerales.', imagenesAdicionales: ['img/snackgato2.jpg', 'img/snackgato3.jpg'] }, // Ajustado a imágenes de snacks de gato disponibles
            { id: 14, nombre: 'Alimento para aves', precio: 12000, stock: 7, imagen: 'img/aveees.png', descripcion: 'Mezcla de semillas y granos enriquecida para aves de jaula.', imagenesAdicionales: ['img/ave2.png', 'img/ave3.png'] } // Ajustado a imágenes de ave disponibles
        ]
    };
